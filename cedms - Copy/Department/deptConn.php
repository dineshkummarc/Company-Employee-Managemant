...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        // Create a new PHP file for this department
        $filename = "department_$deptId.php";
        $fileContent = "<?php
        include 'config.php';
        \$deptId = $deptId;
...
<body>
    ...
    <footer class=\"footer\" id=\"footer\">
        ...
        if (file_put_contents($filename, $fileContent)) {
            echo "<script>alert('Department added successfully!'); window.location.href='financialSum.php';</script>";
        } else {
            echo "<script>alert('Failed to create department page.');</script>";
        }
    } else {
